...
- `alianca-daemon-01` / `Vamos`: no_mechanical_race_signal
- `alianca-daemon-01` / `Nenhum`: no_mechanical_race_signal
- `alianca-daemon-01` / `Somente`: no_mechanical_race_signal
- `alianca-daemon-01` / `CRIAO DE PERSONAGENS`: no_mechanical_race_signal
- `alianca-daemon-01` / `Junto`: no_mechanical_race_signal
- `alianca-daemon-01` / `Miguel`: no_mechanical_race_signal
- `alianca-daemon-01` / `Vrikolakas`: no_mechanical_race_signal
- `alianca-daemon-01` / `Muitos`: no_mechanical_race_signal
- `alianca-daemon-01` / `Rakshasas`: no_lineage_signal
- `alianca-daemon-01` / `Capítulo`: no_mechanical_race_signal
- `alianca-daemon-01` / `Uma`: no_mechanical_race_signal
- `alianca-daemon-01` / `WONDDERFUL KOPENHAGEN`: no_mechanical_race_signal
- `alianca-daemon-01` / `Aqui`: no_mechanical_race_signal
- `alianca-daemon-01` / `Diversas`: no_mechanical_race_signal
- `alianca-daemon-01` / `Américas`: no_mechanical_race_signal
- `alianca-daemon-01` / `PrincipaisÁreas deInfluência`: no_mechanical_race_signal
- `alianca-daemon-01` / `Se forem`: no_mechanical_race_signal
- `alianca-daemon-01` / `Eretiks`: no_mechanical_race_signal
- `alianca-daemon-01` / `, Símbolos Religiosos,`: no_mechanical_race_signal
- `alianca-daemon-01` / `Transformação em Animais`: no_mechanical_race_signal
- `alianca-daemon-01` / `SentirCriaturas`: no_mechanical_race_signal
- `alianca-daemon-01` / `Qatil'Ayn`: no_mechanical_race_signal
- `alianca-daemon-01` / `Ras'Al-Ghul`: no_mechanical_race_signal
- `animalidade` / `Metamorfose`: no_mechanical_race_signal
- `animalidade` / `As Leis`: no_mechanical_race_signal
