...
- `4killers` / `Fred Krueger`: looks_like_stat_block
- `4killers` / `Personalidade`: looks_like_ritual
- `abismo` / `Tenebras`: no_mechanical_magic_signal
- `abismo` / `Infernun`: no_mechanical_magic_signal
- `abismo` / `Tirano`: no_mechanical_magic_signal
- `abismo` / `Invasão Tenebriana`: no_mechanical_magic_signal
- `abismo` / `Varrax`: no_mechanical_magic_signal
- `abismo` / `Ordens`: looks_like_ritual
- `abismo` / `Submeteu`: no_mechanical_magic_signal
- `abismo` / `A Terra`: no_mechanical_magic_signal
- `abismo` / `Pérsia`: looks_like_ritual
- `abismo` / `Grécia`: no_mechanical_magic_signal
- `abismo` / `Roma`: looks_like_ritual
- `alastores-a-justica-infernal` / `Nivel 2: Sentir Características. Como`: name_has_sentence_punctuation
- `alastores-a-justica-infernal` / `Nivel 3: Sentir Efeitos Místicos. O`: name_has_sentence_punctuation
- `alastores-a-justica-infernal` / `Nivel 4: Apagar Características. Como`: name_has_sentence_punctuation
- `alastores-a-justica-infernal` / `Nível 1: Corpo Gélido. O Demônio`: name_has_sentence_punctuation
- `alastores-a-justica-infernal` / `Briga,`: name_has_sentence_punctuation
- `alastores-a-justica-infernal` / `Nível 1: Hoplita. O Personagem,`: name_has_sentence_punctuation
- `alastores-a-justica-infernal` / `Personagem,`: name_has_sentence_punctuation
- `alastores-a-justica-infernal` / `WILL`: name_is_section_or_empty
- `alastores-a-justica-infernal` / `CON,`: name_has_sentence_punctuation
- `alastores-a-justica-infernal` / `Enxofre Negro. Este Enxofre pode`: name_has_sentence_punctuation
- `alastores-a-justica-infernal` / `Nivel 1: Rastrear Luz. Os Templários`: name_has_sentence_punctuation
- `alastores-a-justica-infernal` / `Nivel 3: Exorcismo Celestial. Capaz`: name_has_sentence_punctuation
- `alastores-a-justica-infernal` / `Exemplos`: no_power_term
- `alastores-a-justica-infernal` / `Flagelo`: no_power_term
- `alastores-a-justica-infernal` / `PVs`: name_is_section_or_empty
- `alastores-a-justica-infernal` / `Defesas Especiais`: no_power_term
- `alastores-a-justica-infernal` / `Nivel 3: Cólera. A Personagem`: name_has_sentence_punctuation
- `alianca-daemon-01` / `Vrikolakas`: looks_like_ritual
- `alianca-daemon-01` / `Obediência`: no_mechanical_magic_signal
- `alianca-daemon-01` / `Nível1:`: name_has_sentence_punctuation
- `alianca-daemon-01` / `5) Farol:`: name_has_sentence_punctuation
- `animalidade` / `Adentrar no Umbral`: no_mechanical_power_signal
- `animalidade` / `As Leis`: no_mechanical_power_signal
- `animalidade` / `Criação de Domínio`: no_mechanical_power_signal
- `animalidade` / `O Despertar da Fera`: no_mechanical_power_signal
- `animalidade` / `Regeneração`: looks_like_stat_block
- `animalidade` / `Fraquezas`: no_mechanical_power_signal
- `animalidade` / `Vulnerável`: no_mechanical_power_signal
...
- `anjos-jyhad-faces-da-fe` / `servir Demiurgo. Os Hephzibah`: name_has_sentence_punctuation
- `anjos-jyhad-faces-da-fe` / `Religião e Magia`: no_mechanical_magic_signal
- `anjos-jyhad-faces-da-fe` / `de Magia`: no_mechanical_magic_signal
- `anjos-jyhad-faces-da-fe` / `Primeiro Mandamento. Devem se`: name_has_sentence_punctuation
